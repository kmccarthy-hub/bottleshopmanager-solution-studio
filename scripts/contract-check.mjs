...
const designer = {
  ...
  concepts: [
    { id: "concept-focused", lens: "focused" },
    { id: "concept-integrated", lens: "integrated" },
    { id: "concept-exploratory", lens: "exploratory" },
  ],
};
...
validateDownstreamArtifact("maker", {
  ...
  prototypes: designer.concepts.map((concept) => ({ conceptId: concept.id })),
}, "run-1", artifacts);

assert.throws(() => validateDownstreamArtifact("maker", {
  runId: "run-1", stage: "maker", featureRequestNumber: 4,
  prototypes: [
    { conceptId: "concept-focused", components: [{ body: "Reorder SKU-8420 when sales rise by 80%." }] },
    { conceptId: "concept-integrated", components: [] },
    { conceptId: "concept-exploratory", components: [] },
  ],
}, "run-1", artifacts));
